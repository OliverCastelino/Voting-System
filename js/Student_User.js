...
function loginValidate(loginForm)
{
    ...
    {
        errorMessage+="Invalid User Name/Email provided!\n";
        validationVerified=false;
    }
...
function registerValidate(registerForm)
{
    ...
    {
        errorMessage+="Fullname not filled!\n";
        validationVerified=false;
    }
    ...
    {
        errorMessage+="Phone Number not filled!\n";
        validationVerified=false;
    }
...
if (updateForm.oldpass.value=="")
{
errorMessage+="Please provide your old password.\n";
validationVerified=false;
}
if (updateForm.newpass.value=="")
{
errorMessage+="Please provide a new password.\n";
validationVerified=false;
}
if(updateForm.conpass.value=="")
{
errorMessage+="Please confirm your new password.\n";
validationVerified=false;
}
if(updateForm.conpass.value!=updateForm.newpass.value)
{
