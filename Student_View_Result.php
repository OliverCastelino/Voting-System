  ...
  .carousel-inner > .item > a > img {
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight img" style="background-image: url(images/sidebar-bg.jpg);">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
                    ...
                    <li class="colorlib-active"><a href="Student_View_Result.php">Results</a></li>
        ...
        <header>
            ...
            <h1 style="color:Blue;background-color:pink;text-align:center"><b>Result</b></h1>
            </div>
        </header>
            <section>
            <div style="margin-left:341px;margin-top:50px">
                <form name="fmNames" id="fmNames" method="post" action="Student_View_Result.php" onSubmit="return positionValidate(this)">
                    <br>
