...
<html>
    <head>
        ...
        <link href="css/Student_Registration.css" rel="stylesheet" type="text/css">
    ...
    if (isset($_POST['register']))    
    {
        ...
        $sql = mysqli_query($con, "INSERT INTO Members(Full_Name, Email, Phone_Number, User_Name, password) VALUES ('$Fullname','$Email', '$Phonenumber', '$Username', '$Cnfpassword') ");

        die( "<h2>You have registered for an account</h2><br><br>Go to<t></t> <a href=\"Student_Login.php\">Login</a>" );
    }
    ?>
            <b>
            <h2>Student Registration</h2><br><br>
            <form action="Student_Register.php" method="post" onsubmit="return registerValidate(this)">
                ...
                <input id="password" name="password" placeholder="Password" type="password" value=""><br><br>
                <label id="lb4">Confirm Password :</label><br><br>
                <input id="password" name="confirmpassword" placeholder="Confirm Password" type="password" value=""><br><br>
                <br><br>
                <input name="register" type="submit" value=" Register "><br><br><br>
                <i>Already have an account?</i> <a href='Student_Login.php'><b>  Login Here</b></a><br><br>
